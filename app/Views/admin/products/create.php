                        ...
                        <?php else: ?>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <?= form_input('sku', set_value('sku', isset($product->sku) ? ($product->sku) : ''), ['class' => 'form-control', 'id' => 'productSku', 'placeholder' => 'Masukkan sku produk', 'required' => true]) ?>
                                </div>
                                <div class="form-group">
                                    <label for="productName">Name</label>
                                    <?= form_input('name', set_value('name', isset($product->name) ? ($product->name) : ''), ['class' => 'form-control', 'id' => 'productName', 'placeholder' => 'Masukkan nama produk', 'required' => true]) ?>
                                </div>
                                <div class="form-group">
