...
class AttributeModel extends Model
{
    ...
    protected $validationMessages = [
        'code' => [
            'required'   => 'Code attribute wajib diisi.',
            'min_length' => 'Code attribute minimal harus 3 karakter.',
        ],
        'name' => [
            'required'   => 'Nama attribute wajib diisi.',
        ],
        'type' => [
            'required'   => 'Type attribute wajib diisi.',
        ],
    ];
