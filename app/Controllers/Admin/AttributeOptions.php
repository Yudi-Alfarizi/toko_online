...
class AttributeOptions extends BaseController
{
    ...
    {
        if (!$attributeId) {
            $this->session->setFlashdata('errors', 'Opsi atribut tidak valid!');
    ...
    public function store()
    {
        ...
        if ($this->attributeOptionModel->save($params)) {
            $this->session->setFlashdata('success', 'Attribute option berhasil disimpan');
    ...
    public function update($id, $attributeId)
    {
        ...
        $this->attributeOptionModel->setValidationRules([
    ...
    public function destroy($id)
    {
        ...
        if ($this->attributeOptionModel->delete($attributeOption->id)) {
            $this->session->setFlashdata('success', 'Attribute option berhasil dihapus');
            return redirect()->to('/admin/attribute-options/' . $attributeId);
        } else {
            $this->session->setFlashdata('errors', 'Tidak dapat menghapus opsi atribut!');
            return redirect()->to('/admin/attribute-options/' . $attributeId);
        }
    }
}